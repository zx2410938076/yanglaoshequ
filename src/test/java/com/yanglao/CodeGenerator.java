...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        String tables = "sys_user,see_doctor,request,physical_examination,make_appointment,doctor_advice,dish,disease,complaint,activity,abnormal,hospital_appointment";
